// Builds public/models/mannequin.glb from the Quaternius Universal Animation Library source
...
const OUT = new URL('../public/models/mannequin.glb', import.meta.url)
